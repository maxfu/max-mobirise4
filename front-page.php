			...
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<section class="features18 popup-btn-cards cid-qSS90kYbjZ" id="features18-7">
					<div class="container">
						...
						<div class="media-container-row pt-5 ">
							<?php $custom_loop = new WP_Query(array( 'post_type' => 'post', 'posts_per_page' => 3, 'category_name' => 'frontpagenews', 'orderby' => 'date', 'order' => 'DESC')); ?>
							<?php while ( $custom_loop->have_posts() ) : $custom_loop->the_post(); ?>
				...
				<section class="features11 mbr-section content4 cid-qSShVnZyJK" id="content4-p">
					<div class="event_loop container">
						...
						<?php $custom_loop = new WP_Query(array( 'post_type' => 'event_moment', 'posts_per_page' => 5, 'orderby' => 'date', 'order' => 'DESC')); ?>
						<?php while ( $custom_loop->have_posts() ) : $custom_loop->the_post(); ?>
